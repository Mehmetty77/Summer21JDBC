...
public class JdbcExecuteUpdate01 {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		// 1.Example: Insert 104 and Huawei into my_companies table
...
//		}
		...
		String q3 = "UPDATE employees SET employee_first_name = 'SAM' WHERE employee_id = 14";
		int r3 = st.executeUpdate(q3);
		System.out.println(r3 + " row/s updated");

		String q4 = "SELECT * FROM employees";
		ResultSet r4 = st.executeQuery(q4);
		while (r4.next()) {
			System.out.println(r4.getString("employee_first_name"));
		}
...
//		}
		...
		List<MyCompaniesPojo> records = new ArrayList<MyCompaniesPojo>();
